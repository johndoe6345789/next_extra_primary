...
export function DatePicker({
  ...
  return (
    <div className={classNames('m3-datepicker', className)} style={sx} data-testid={testId} aria-label={label}>
      {label && <label className="m3-datepicker-label">{label}</label>}
      <input {...inputProps} />
    </div>
  )
}
...
export function TimePicker({
  ...
  return (
    <div className={classNames('m3-timepicker', className)} style={sx}>
      {label && <label className="m3-timepicker-label">{label}</label>}
      <input {...inputProps} />
    </div>
  )
}
...
export function DateTimePicker({
  ...
  return (
    <div className={classNames('m3-datetimepicker', className)} style={sx}>
      {label && <label className="m3-datetimepicker-label">{label}</label>}
      <input {...inputProps} />
    </div>
  )
}
