...
export function Timeline({ children, position = 'right', className, testId, ...props }: TimelineProps) {
  return (
    <ul className={classNames('m3-timeline', `m3-timeline-position-${position}`, className)} data-testid={testId} {...props}>
      {children}
    </ul>
  )
}
...
export function TimelineItem({ children, position, className, ...props }: TimelineItemProps) {
  return (
    <li
      className={classNames('m3-timeline-item', position && `m3-timeline-item-position-${position}`, className)}
      {...props}
    >
      {children}
    </li>
...
export function TimelineConnector({ className, ...props }: TimelineConnectorProps) {
  return <span className={classNames('m3-timeline-connector', className)} {...props} />
}
...
export function TimelineDot({ children, color = 'grey', variant = 'filled', className, ...props }: TimelineDotProps) {
  return (
    <span
      className={classNames('m3-timeline-dot', `m3-timeline-dot-${variant}`, `m3-timeline-dot-${color}`, className)}
      {...props}
    >
      {children}
    </span>
...
export function TimelineOppositeContent({ children, className, ...props }: TimelineOppositeContentProps) {
  return (
    <div className={classNames('m3-timeline-opposite-content', className)} {...props}>
      {children}
    </div>
  )
}
