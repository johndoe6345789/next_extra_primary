...
const DATA = [
  { i: <ChatIcon color={P} />,
    t: 'AI Chat', d: 'Chat with AI models.' },
  { i: <EmojiEventsIcon color={P} />,
    t: 'Gamification', d: 'Badges and boards.' },
  { i: <NotificationsActiveIcon color={P} />,
    t: 'Real-time Alerts', d: 'Instant alerts.' },
  { i: <DarkModeIcon color={P} />,
    t: 'Dark Mode', d: 'Light and dark themes.' },
  { i: <TranslateIcon color={P} />,
    t: 'Multi-language', d: 'Five languages.' },
  { i: <LockIcon color={P} />,
    t: 'Secure Auth', d: 'JWT with refresh.' },
];
