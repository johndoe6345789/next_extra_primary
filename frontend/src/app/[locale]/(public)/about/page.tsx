  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" paragraph>
        ExtraPrimary is a gamified learning platform
        that combines AI-powered tutoring with
        engaging progression mechanics.
      </Typography>
      <Typography variant="body1" paragraph>
        Earn badges, maintain streaks, climb
        leaderboards, and learn at your own
      ...
      <Typography variant="body1">
        To make education accessible, engaging,
        and rewarding for learners everywhere.
      </Typography>
    </Container>
  );
}
